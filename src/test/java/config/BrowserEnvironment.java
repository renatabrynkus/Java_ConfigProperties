...
public class BrowserEnvironment {
    ...
    private void initBrowserSettings() {
        this.webElementTimeOut = PropertiesStore.BROWSER_WEB_ELEMENT_TIMEOUT.isSpecified() ? PropertiesStore.BROWSER_WEB_ELEMENT_TIMEOUT.getIntValue() : this.webElementTimeOut;
