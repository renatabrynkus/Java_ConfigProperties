...
public abstract class Log {
    ...
    public static void logDriverQuitSuccessMessage(Logger logger) {
        logger.info("WebDriver has been quit");
    }

    public static void logDriverNotQuit(Logger logger) {
        logger.info("It was not possible to quit the driver");
    }
